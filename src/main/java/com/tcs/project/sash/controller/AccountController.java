	...
	public ModelAndView navigateToWithdrawService(@RequestParam("id") String id)
	{
		...
		if(id != null)
		{
			...
			if(account != null)
			{
				...
				ModelAndView mv = new ModelAndView("banking/search_withdraw");
				mv.addObject("alert", "Account is not avaiable...!!");
				return mv;
			}
			
			ModelAndView mv = new ModelAndView("banking/search_withdraw");
			mv.addObject("alert", "Account ID is Invalied...!!");
			return mv;
		}
	...
	public ModelAndView navigateToTransferService(@RequestParam("id") String id)
	{
		...
		if(id != null)
		{
			...
			if(customer != null)
			{
				...
				ModelAndView mv = new ModelAndView("banking/search_transfer");
				mv.addObject("alert", "Customer ID is not avaiable...!!");
				return mv;
			}
			
			ModelAndView mv = new ModelAndView("banking/search_transfer");
			mv.addObject("alert", "Customer ID is Invalied...!!");
			return mv;
		}
			
			ModelAndView mv = new ModelAndView("banking/search_transfer");
			mv.addObject("customer", customer);
			mv.addObject("alert", "Please Enter Customer ID..!!!");
			return mv;
	}
