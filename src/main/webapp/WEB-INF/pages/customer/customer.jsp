...
<body>
	...
	<div class="container-fluid">
		...
		<div class="jumbotron alert alert-primary">
			...
			<hr>
			<div class="col-sm-10">
				<a href="/sash/customer/update/search/id2" class="btn btn-success" tabindex="-1" role="button" aria-disabled="true">UPDATE</a>
				<a href="/sash/customer/delete/search/id" class="btn btn-danger" tabindex="-1" role="button" aria-disabled="true">DELETE</a>
